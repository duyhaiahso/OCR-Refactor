...
const translationOverrides: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.ocrTestTitle": "OCR test rotation",
    "settings.ocrTestDescription":
      "Developer-only settings for rotating ROI crops 90 degrees clockwise before test transmission.",
    ...
    "settings.ocrTestRotateLabel": "Rotate crop 90 degrees clockwise before transmit",
    "settings.ocrTestRotateHint":
      "This affects test-image crops only and does not change ROI coordinates.",
    ...
    "settings.ocrTestSave": "Apply setting",
    "settings.ocrTestSaving": "Applying OCR test setting...",
    "settings.ocrTestSaved": "Applied OCR test setting to {count} product(s).",
    "settings.ocrTestSaveError": "Cannot apply OCR test setting.",
  ...
  vi: {
    ...
    "lineTabs.test": "Test",
    "settings.tabOcrTest": "OCR test",
    "settings.ocrTestTitle": "Xoay ảnh OCR test",
    "settings.ocrTestDescription":
      "Setting riêng cho dev để xoay crop ROI 90 độ theo chiều kim đồng hồ trước khi gửi ảnh test.",
    ...
    "settings.ocrTestRotateLabel": "Xoay crop 90 độ theo chiều kim đồng hồ trước khi truyền",
    "settings.ocrTestRotateHint":
      "Chỉ ảnh hưởng crop dùng để test, không làm thay đổi tọa độ ROI.",
    ...
    "settings.ocrTestSave": "Áp dụng setting",
    "settings.ocrTestSaving": "Đang áp dụng setting OCR test...",
    "settings.ocrTestSaved": "Đã áp dụng setting OCR test cho {count} mã hàng.",
    "settings.ocrTestSaveError": "Không thể áp dụng setting OCR test.",
