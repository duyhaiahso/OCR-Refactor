...
const translations = {
  en: {
    ...
    "apiError.Only dev can update OCR test settings":
      "Only dev can update OCR test settings.",
    ...
    "login.ready": "Local API and dongle are ready.",
    "login.blocked": "Cannot sign in until the license dongle is valid.",
    ...
    "settings.description": "Configure the local desktop window and station display.",
    ...
    "settings.desktopOnly": "This action is only available in the Electron app.",
  ...
  vi: {
    ...
    "apiError.Only dev can update OCR test settings":
      "Chỉ dev mới có thể cập nhật setting test OCR.",
...
const translationOverrides: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.ocrTestTitle": "OCR crop rotation",
    "settings.ocrTestDescription":
      "Developer-only settings for rotating ROI crops 90 degrees clockwise before OCR processing in inspection, camera AI, and test flows.",
    "settings.ocrTestApplyMode": "Apply mode",
    "settings.ocrTestApplyAll": "Apply to all products",
    "settings.ocrTestApplyAllHint":
      "Use one rotation setting for every product profile.",
    "settings.ocrTestApplySelected": "Apply to selected products",
    "settings.ocrTestApplySelectedHint":
      "Choose specific product codes that need the rotation setting.",
    "settings.ocrTestRotateLabel": "Rotate crop 90 degrees clockwise before OCR",
    "settings.ocrTestRotateHint":
      "This changes OCR crop orientation without changing ROI coordinates.",
    ...
    "settings.ocrTestSave": "Apply rotation setting",
    "settings.ocrTestSaving": "Applying OCR crop rotation setting...",
    "settings.ocrTestSaved": "Applied OCR crop rotation setting to {count} product(s).",
    "settings.ocrTestSaveError": "Cannot apply OCR crop rotation setting.",
    ...
    "settings.ocrTestStorageTitle": "Batch test image storage",
    "settings.ocrTestStorageDescription":
      "Choose a desktop folder for saving failed batch-test images and the session report JSON file.",
    "settings.ocrTestStorageFolder": "Save folder",
    "settings.ocrTestStorageFolderHint":
      "Each batch test session will create a separate subfolder inside this location.",
    ...
    "settings.ocrTestStorageSaved": "Test save folder updated.",
    "settings.ocrTestStorageSaveError": "Cannot save the test folder setting.",
    "settings.ocrTestStorageLoadError": "Cannot load the test folder setting.",
    ...
    "lineTest.batchReportSaveFailed": "Folder test finished but the report could not be saved.",
    ...
    "lineTest.batchReportEmpty": "Choose a folder and run the batch test to see the report.",
    ...
    "lineTest.batchReportNothingToSave": "There is no batch report to save yet.",
    ...
    "lineTest.rotateBeforeTransmit": "Rotate crop 90° clockwise before transmit",
    "lineTest.savingRotateSetting": "Saving rotation setting...",
    "lineTest.rotateSettingSaved": "Rotation setting saved.",
    "lineTest.rotateSettingSaveError": "Cannot save rotation setting.",
    "lineTest.cropPreview": "Transmitted crops",
    "lineTest.cropPreviewEmpty": "Transmit an image to preview the exact ROI crops sent to AI.",
    "lineTest.roiSlot": "ROI",
    "lineTest.cropSize": "Crop",
    "lineTest.sourceSize": "Source",
    "lineTest.cropRotated": "Rotate before transmit: on",
    "lineTest.cropNotRotated": "Rotate before transmit: off",
  ...
  vi: {
    ...
    "settings.ocrTestTitle": "Xoay crop OCR",
    "settings.ocrTestDescription":
      "Setting riêng cho dev để xoay crop ROI 90 độ theo chiều kim đồng hồ trước khi OCR xử lý ở luồng chạy thật, camera AI và luồng test.",
    "settings.ocrTestApplyMode": "Phạm vi áp dụng",
    "settings.ocrTestApplyAll": "Áp dụng cho toàn bộ mã hàng",
    "settings.ocrTestApplyAllHint":
      "Dùng cùng một setting xoay cho toàn bộ profile sản phẩm.",
    "settings.ocrTestApplySelected": "Áp dụng cho mã hàng đã chọn",
    "settings.ocrTestApplySelectedHint":
      "Chọn riêng các mã hàng cần bật hoặc tắt setting xoay.",
    "settings.ocrTestRotateLabel": "Xoay crop 90 độ theo chiều kim đồng hồ trước khi OCR",
    "settings.ocrTestRotateHint":
      "Chỉ đổi hướng crop đưa vào OCR, không làm thay đổi tọa độ ROI.",
    ...
    "settings.ocrTestSave": "Áp dụng setting xoay",
    "settings.ocrTestSaving": "Đang áp dụng setting xoay crop OCR...",
    "settings.ocrTestSaved": "Đã áp dụng setting xoay crop OCR cho {count} mã hàng.",
    "settings.ocrTestSaveError": "Không thể áp dụng setting xoay crop OCR.",
    ...
    "settings.ocrTestStorageTitle": "Thư mục lưu ảnh batch test",
    "settings.ocrTestStorageDescription":
      "Chọn thư mục trên bản Electron để lưu các ảnh lỗi khi batch test và file session-report.json.",
    "settings.ocrTestStorageFolder": "Thư mục lưu",
    "settings.ocrTestStorageFolderHint":
      "Mỗi lần chạy batch test sẽ tạo một thư mục con riêng trong vị trí này.",
    ...
    "settings.ocrTestStorageSaved": "Đã cập nhật thư mục lưu test.",
    "settings.ocrTestStorageSaveError": "Không thể lưu thư mục test.",
    "settings.ocrTestStorageLoadError": "Không thể tải thư mục test.",
    "settings.ocrTestStorageEmpty": "Chưa chọn thư mục",
    "settings.ocrTestStorageState": "Thư mục lưu batch",
    "lineTest.productsLoadError": "Kh\u00f4ng th\u1ec3 t\u1ea3i profile s\u1ea3n ph\u1ea9m \u0111\u1ec3 test.",
    ...
    "lineTest.batchReportSaveFailed": "Đã test xong folder nhưng không thể lưu report.",
    ...
    "lineTest.batchReportEmpty": "Chọn folder và chạy test hàng loạt để xem báo cáo.",
    ...
    "lineTest.savedSessionsEmpty": "Chưa có session test hàng loạt nào được lưu.",
    ...
    "lineTest.imageReady": "\u1ea2nh \u0111\u00e3 s\u1eb5n s\u00e0ng \u0111\u1ec3 test.",
    "lineTest.selectProductFirst": "Vui l\u00f2ng ch\u1ecdn profile s\u1ea3n ph\u1ea9m tr\u01b0\u1edbc.",
    "lineTest.modelRequired": "Product \u0111ang ch\u1ecdn c\u1ea7n c\u00f3 \u0111\u01b0\u1eddng d\u1eabn model.",
    "lineTest.roiRequired": "Product \u0111ang ch\u1ecdn c\u1ea7n c\u00f3 \u00edt nh\u1ea5t 1 ROI.",
    "lineTest.selectImageFirst": "Vui l\u00f2ng ch\u1ecdn \u1ea3nh tr\u01b0\u1edbc khi truy\u1ec1n.",
    "lineTest.transmitting": "\u0110ang truy\u1ec1n \u1ea3nh...",
    "lineTest.testPassed": "Tool v\u00e0 AI \u0111\u00e3 tr\u1ea3 k\u1ebft qu\u1ea3 OK.",
    "lineTest.testReturnedNg": "Tool v\u00e0 AI \u0111\u00e3 tr\u1ea3 k\u1ebft qu\u1ea3 NG.",
    "lineTest.testFailed": "Kh\u00f4ng th\u1ec3 test \u1ea3nh qua Tool/AI.",
    "lineTest.result": "K\u1ebft qu\u1ea3",
    "lineTest.totalSlots": "S\u1ed1 v\u00f9ng",
    "lineTest.cycleTime": "Th\u1eddi gian x\u1eed l\u00fd",
    ...
    "lineTest.error": "L\u1ed7i",
    "lineTest.emptyResult": "Truy\u1ec1n \u1ea3nh \u0111\u1ec3 xem k\u1ebft qu\u1ea3 Tool/AI.",
    "lineTest.resetRoi": "\u0110\u1eb7t l\u1ea1i ROI",
    "lineTest.roiReset": "\u0110\u00e3 \u0111\u1eb7t l\u1ea1i ROI test.",
    "lineTest.syncRoiShape": "\u0110\u1ed3ng b\u1ed9 chi\u1ec1u ROI",
    "lineTest.roiShapeSynced": "\u0110\u00e3 \u0111\u1ed3ng b\u1ed9 ROI sang d\u1ea1ng d\u1ecdc.",
    "lineTest.roiShapeAlreadySynced": "ROI \u0111\u00e3 \u1edf d\u1ea1ng d\u1ecdc.",
    "lineTest.saveRoi": "L\u01b0u ROI",
    "lineTest.roiSaving": "\u0110ang l\u01b0u ROI...",
    "lineTest.roiSaved": "\u0110\u00e3 l\u01b0u ROI v\u00e0o m\u00e3 h\u00e0ng hi\u1ec7n t\u1ea1i.",
    "lineTest.roiSaveError": "Kh\u00f4ng th\u1ec3 l\u01b0u ROI cho m\u00e3 h\u00e0ng hi\u1ec7n t\u1ea1i.",
    "lineTest.roiSaveNoChanges": "ROI hi\u1ec7n kh\u00f4ng c\u00f3 thay \u0111\u1ed5i \u0111\u1ec3 l\u01b0u.",
    "lineTest.roiStatusDraft": "ROI ch\u01b0a l\u01b0u",
    "lineTest.roiStatusSaved": "ROI \u0111\u00e3 l\u01b0u",
    "lineTest.rotateBeforeTransmit": "Xoay crop 90\u00b0 theo chi\u1ec1u kim \u0111\u1ed3ng h\u1ed3 tr\u01b0\u1edbc khi truy\u1ec1n",
    "lineTest.savingRotateSetting": "\u0110ang l\u01b0u setting xoay...",
    "lineTest.rotateSettingSaved": "\u0110\u00e3 l\u01b0u setting xoay.",
    "lineTest.rotateSettingSaveError": "Kh\u00f4ng th\u1ec3 l\u01b0u setting xoay.",
    "lineTest.cropPreview": "Crop \u0111\u00e3 truy\u1ec1n",
    "lineTest.cropPreviewEmpty": "Truy\u1ec1n \u1ea3nh \u0111\u1ec3 xem \u0111\u00fang crop ROI \u0111\u00e3 g\u1eedi v\u00e0o AI.",
    "lineTest.roiSlot": "ROI",
    "lineTest.cropSize": "Crop",
    "lineTest.sourceSize": "Ngu\u1ed3n",
    "lineTest.cropRotated": "Xoay tr\u01b0\u1edbc khi truy\u1ec1n: b\u1eadt",
    "lineTest.cropNotRotated": "Xoay tr\u01b0\u1edbc khi truy\u1ec1n: t\u1eaft",
    ...
    "cameraDebug.dropPoint": "\u0110i\u1ec3m b\u1eaft \u0111\u1ea7u r\u01a1i FPS",
    "cameraDebug.dropCameraTool": "Camera -> Tool",
    "cameraDebug.dropToolBackend": "Tool -> Backend",
    "cameraDebug.dropBackendFe": "Backend -> FE",
    ...
    "camera.aiResultError": "Kh\u00f4ng th\u1ec3 nh\u1eadn k\u1ebft qu\u1ea3 AI OCR.",
    "camera.aiModelRequired": "Product \u0111ang ch\u1ecdn c\u1ea7n c\u00f3 \u0111\u01b0\u1eddng d\u1eabn model.",
    "camera.aiRoiRequired": "Product \u0111ang ch\u1ecdn c\u1ea7n c\u00f3 \u00edt nh\u1ea5t 1 ROI.",
    "camera.aiResults": "K\u1ebft qu\u1ea3 AI OCR",
    "camera.aiResultsEmpty": "B\u1eadt AI OCR \u0111\u1ec3 nh\u1eadn text t\u1eeb camera.",
    "camera.aiOn": "AI b\u1eadt",
    "camera.aiOff": "AI t\u1eaft",
    ...
    "login.blocked":
      "Kh\u00f4ng th\u1ec3 \u0111\u0103ng nh\u1eadp khi dongle b\u1ea3n quy\u1ec1n ch\u01b0a h\u1ee3p l\u1ec7.",
